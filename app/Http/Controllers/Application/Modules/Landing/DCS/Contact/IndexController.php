...
//Get Controller Path
namespace App\Http\Controllers\Application\Modules\Landing\DCS\Contact;
...
class IndexController extends Controller{
	...
	**************************************************************************************/
	public function routePath(){
		...
		//Set Route View
		$this->route_link['view'] = config('routing.application.modules.landing.dcs.view').'.contact.';
