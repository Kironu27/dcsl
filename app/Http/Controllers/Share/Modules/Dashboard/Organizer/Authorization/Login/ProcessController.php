...
namespace App\Http\Controllers\Share\Modules\Dashboard\Customer\Authorization\Login;
...
//Model
use App\Http\Models\IUKL\MYSQL\Table\Organizer;
...
class ProcessController extends Controller{
  ...
  **************************************************************************************/
  public function routePath(){
    ...
    $this->hyperlink['page']['home']['customer'] = config('routing.iukl.modules.dashboard.customer.name').'.home';
...
// dd($request);
    ...
    $credentials = $request->only('customer_id','password');
...
// dd(Auth::guard());
  ...
  protected function credentials(Request $request){
    ...
    switch($request->guard){
      ...
      case 'customer':
        ...
        //Set Field
        $field = 'customer_id';
        // $field = filter_var($request->input($this->username()), FILTER_VALIDATE_EMAIL) ?'email':'customer_id';
  ...
  public function sendLoginStatusResponse(Request $request){
    ...
    switch($status){
      ...
      default:
        ...
        //Get Message
        $message = 'Customer is '.$status.'. Please Contact Support';
   ...
   * @return string
   */
  public function username(){return 'customer_id';}
