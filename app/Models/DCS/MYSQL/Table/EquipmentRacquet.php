...
//Get Class
class EquipmentRacquet extends Model{

  //Table Name
  protected $table = 'equipment_racquet';
  ...
  //Primary Key
  protected $primaryKey = 'equipment_racquet_id';
  ...
  public function selectBox($data = null){
    ...
    $result = DB::connection($this->connection)->table($this->table)
                                               ->select(
                                                  ...
                                                  $this->table.'.equipment_racquet_id AS equipment_racquet_id',
  ...
  public function viewSelected($data){
    ...
    $result = $result->select(
                    ...
                    ->leftJoin('sport','sport.sport_id','=',$this->table.'.sport_id')
                    ->where($this->table.'.equipment_racquet_id',$data['column']['id'])
                    ->first();
