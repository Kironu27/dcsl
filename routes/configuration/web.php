...
/**************************************************************************************
  Command Prompt
**************************************************************************************/
Route::get('/command/prompt',config('routing.configuration.modules.controller').'\Command\Prompt\IndexController@index')->name(config('routing.configuration.modules.name').'.refresh');

/**************************************************************************************
  Route List
**************************************************************************************/
Route::get('/route/list',config('routing.configuration.modules.controller').'\Route\ListController@index')->name(config('routing.configuration.modules.name').'.route.list');
