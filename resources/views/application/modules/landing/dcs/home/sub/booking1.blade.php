        ...
        <article class="card">
          ...
          <div class="card-body">
            ...
            <div class="columns">
              ...
              <div class="column">
                <label class="label">Court Available</label>
                <div class="select" style="width:100%;">
                  <select name="s" style="width:100%;">
                    ...
                    <option>Court 8</option>
                    <option>Court 9</option>
                    <option>Court 10</option>
                  </select>
                </div>
              </div>
              ...
              <div class="column">
                ...
                <input class="input" type="time" placeholder="Text input">
              </div>
