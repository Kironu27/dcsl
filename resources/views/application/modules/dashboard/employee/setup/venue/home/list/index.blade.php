						...
						<div class="widget widget-about">
							...
							<div class="columns">
								<div class="column is-half">
									<h3 class="has-text-left">Manage Venue</h3>
								</div>
								...
								<tbody>
									@if($data['main'])
										...
										<tr>
											...
											<td>{{ $value->name }}</td>
											<td>{{ $value->venue_category_name }}</td>
											<td>
												<h5>
												<span class="tag
													@switch($value->status)
											...
											<td class="has-text-centered">
												<a href="{{ route($hyperlink['page']['view'],['id'=>$value->venue_id]) }}"><i class="ti-ruler-pencil has-text-black"></i></a>
												<span class="btn-delete" data-href="{{ route($hyperlink['page']['delete'],['id'=>$value->venue_id]) }}" data-swal-template="#my-template"><i class="ti-trash"></i></span>
											</td>
										</tr>
