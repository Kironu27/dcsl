				...
				<div class="columns">
					...
					<div class="column is-full">
						...
						<div class="widget widget-about">
							<h3 class="has-text-left">View Venue</h3>
									...
									{{ csrf_field() }}
										...
										<div class="columns is-multiline">
											...
											<div class="input-group py-0 column is-6">
												...
												<input type="text" class="input" placeholder="Enter Code" name="id" value="{{ $data['main']->venue_id }}" readonly>
											</div>
											<!-- end id -->

											<!-- name -->
											<div class="input-group py-0 column is-6">
												<label for="name">Venue Category</label>
												<input type="text" class="input" placeholder="Enter name" name="name" value="{{ $data['main']->venue_category_name }}" readonly>
											</div>
											<!-- end name -->
											...
											<div class="input-group py-0 column is-6">
												...
												<input type="text" class="input" placeholder="Enter name" name="name" value="{{ $data['main']->name }}" readonly>
											</div>
											<!-- end name -->
											...
											<div class="input-group py-0 column is-12 has-text-centered">
												<input type="hidden" name="id" value="{{ $data['main']->venue_id }}">
												<a href="{{ route($hyperlink['page']['list']) }}" class="button is-warning">Back</a>
												<button type="button" id="btn-delete" data-href="{{ route($hyperlink['page']['delete'],['id'=>$data['main']->venue_id]) }}" class="button is-danger" data-swal-template="#my-template">Delete</button>
