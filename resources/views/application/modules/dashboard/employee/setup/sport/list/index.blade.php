						...
						<div class="widget widget-about">
							...
							<div class="columns">
								<div class="column is-half">
									<h3 class="has-text-left">Manage Sports</h3>
								</div>
												...
												@if($data['main'])
													...
													<tr>
														...
														<td class="has-text-centered">
															<a href="{{ route($hyperlink['page']['view'],['id'=>$value->sport_id]) }}"><i class="ti-ruler-pencil has-text-black"></i></a>
															<span class="btn-delete" data-href="{{ route($hyperlink['page']['delete'],['id'=>$value->sport_id]) }}" data-swal-template="#my-template"><i class="ti-trash"></i></span>
														</td>
													</tr>
