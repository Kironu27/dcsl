				...
				<div class="columns">
					...
					<div class="column is-full">
						...
						<div class="widget widget-about">
							<h3 class="has-text-left">View Sports</h3>
				          ...
				          <form action="{{ route($hyperlink['page']['update']) }}" method="POST">
							...
							<div class="columns is-multiline">
								...
								<div class="input-group py-0 column is-6">
									...
									<input type="text" class="input" placeholder="Enter Code" name="id" value="{{ $data['main']->sport_id }}">
								</div>
								<!-- end name -->
								...
								<div class="input-group py-0 column is-12 has-text-centered">
									<input type="hidden" name="id" value="{{ $data['main']->sport_id }}">
									<a href="{{ route($hyperlink['page']['list']) }}" class="button is-warning">Back</a>
									<button type="button" id="btn-delete" data-href="{{ route($hyperlink['page']['delete'],['id'=>$data['main']->sport_id]) }}" class="button is-danger" data-swal-template="#my-template">Delete</button>
