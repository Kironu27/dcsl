				...
				<div class="columns">
					...
					<div class="column is-full">
						...
						<div class="widget widget-about">
							<h3 class="has-text-left">Add Equipment Ball</h3>
										...
										<div class="columns is-multiline">
											...
											<div class="input-group py-0 column is-6">
												...
												<select class="input" name="type">
													<option value="">Please Select</option>
													<option value="feather" {{ ((old('type') == 'feather')?'selected':'') }}>Feather</option>
													<option value="synthetic" {{ ((old('type') == 'synthetic')?'selected':'') }}>Synthetic</option>
												</select>
											</div>
											<!-- end type -->
