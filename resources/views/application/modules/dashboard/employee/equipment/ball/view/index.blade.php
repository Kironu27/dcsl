				...
				<div class="columns">
					...
					<div class="column is-full">
						...
						<div class="widget widget-about">
							<h3 class="has-text-left">View Equipment Ball</h3>
										...
										<div class="columns is-multiline">
											...
											<div class="input-group py-0 column is-6">
												...
												<select class="input" name="type">
													<option value="">Please Select</option>
													<option value="feather" {{ (($data['main']->type == 'feather')?'selected':'') }}>Feather</option>
													<option value="synthetic" {{ (($data['main']->type == 'synthetic')?'selected':'') }}>Synthetic</option>
												</select>
											</div>
											<!-- end type -->
											...
											<div class="input-group py-0 column is-12 has-text-centered">
												<input type="hidden" name="id" value="{{ $data['main']->equipment_ball_id }}">
												<a href="{{ route($hyperlink['page']['list']) }}" class="button is-warning">Back</a>
												<button type="button" id="btn-delete" data-href="{{ route($hyperlink['page']['delete'],['id'=>$data['main']->equipment_ball_id]) }}" class="button is-danger" data-swal-template="#my-template">Delete</button>
