						...
						<div class="widget widget-about">
							...
							<div class="columns">
								<div class="column is-half">
									<h3 class="has-text-left">Manage Equipment Racquet</h3>
								</div>
												...
												@if($data['main'])
													...
													<tr>
														...
														<td class="has-text-centered">
															<a href="{{ route($hyperlink['page']['view'],['id'=>$value->equipment_racquet_id]) }}"><i class="ti-ruler-pencil has-text-black"></i></a>
															<span class="btn-delete" data-href="{{ route($hyperlink['page']['delete'],['id'=>$value->equipment_racquet_id]) }}" data-swal-template="#my-template"><i class="ti-trash"></i></span>
														</td>
													</tr>
