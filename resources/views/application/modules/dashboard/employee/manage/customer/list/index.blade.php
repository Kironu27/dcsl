						...
						<div class="widget widget-about">
							...
							<div class="columns">
								<div class="column is-half">
									<h3 class="has-text-left">Manage Customer</h3>
								</div>
				            ...
				            <!-- table -->
					                ...
					                <th class="has-text-centered">Action</th>
							                ...
							                <td class="has-text-centered">
																<a href="{{ route($hyperlink['page']['view'],['id'=>$value->customer_id]) }}"><i class="ti-ruler-pencil has-text-black"></i></a>
																<span class="btn-delete" data-href="{{ route($hyperlink['page']['delete'],['id'=>$value->customer_id]) }}" data-swal-template="#my-template"><i class="ti-trash"></i></span>
															</td>
								            </tr>
